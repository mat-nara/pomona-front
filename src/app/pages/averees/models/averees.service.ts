...
import { TableBulletin, SearchResultBulletin } from './bulletin-courant.model';
 ...
 */
function sort(tables: TableBulletin[], column: string, direction: string): TableBulletin[] {
  if (direction === '' || column === '') {
    return tables;
  } else {
 ...
 */
function matches(tables: TableBulletin, term: string, pipe: PipeTransform) {
...
export class AvereesService {
  // tslint:disable-next-line: variable-name
  private _loading$ = new BehaviorSubject<boolean>(true);
  // tslint:disable-next-line: variable-name
  private _search$ = new Subject<void>();
  // tslint:disable-next-line: variable-name
  private _tables$ = new BehaviorSubject<TableBulletin[]>([]);
  // tslint:disable-next-line: variable-name
   ...
   * Search Method
   */
  private _search(): Observable<SearchResultBulletin> {
